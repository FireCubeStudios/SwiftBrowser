...
namespace SwiftBrowser.Helpers
{
    public class TileDataSource
    {
...

        {
            ...
            if (_photos == null) await LoadAsync(online, maxCount);
...

        {
            ...
            if (_groupedPhotos == null) await LoadAsync(online, maxCount);
...

        {
            ...
            foreach (var group in _photos.GroupBy(x => x.Category)) _groupedPhotos.Add(group);
        }
