...
namespace SwiftBrowser.SettingsViews
{
    ...
    public sealed partial class PrivacySettings : Page
    {
        ...
        public PrivacySettings()
        {
            ...
            Setup();
            privacyToggleHistory.IsOn = (bool) ApplicationData.Current.LocalSettings.Values["StoreHistory"];
        }
        ...
        {
            ApplicationData.Current.LocalSettings.Values["StoreHistory"] = privacyToggleHistory.IsOn;
        }
    }
}
